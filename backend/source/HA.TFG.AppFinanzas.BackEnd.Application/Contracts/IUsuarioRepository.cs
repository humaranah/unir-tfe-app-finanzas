...
public interface IUsuarioRepository
{
    ...
    Task<Usuario> CreateAsync(Usuario usuario, Identidad identidad, CancellationToken cancellationToken);
    Task AddIdentidadAsync(Guid idUsuario, Identidad identidad, CancellationToken cancellationToken);
