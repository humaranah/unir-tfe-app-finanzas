...
public class EnsureUsuarioCommandValidatorTests
{
    ...
    {
        var command = new EnsureUsuarioCommand(idAuth0, "test@test.com", "Test", null, true, null);
    ...
    {
        var command = new EnsureUsuarioCommand(new string('a', 101), "test@test.com", "Test", null, true, null);
    ...
    {
        var command = new EnsureUsuarioCommand("auth0|123", email, "Test", null, true, null);
    ...
    {
        var command = new EnsureUsuarioCommand("auth0|123", "no-es-un-email", "Test", null, true, null);
    ...
    {
        var command = new EnsureUsuarioCommand("auth0|123", new string('a', 250) + "@b.com", "Test", null, true, null);
    ...
    {
        var command = new EnsureUsuarioCommand("auth0|123", "test@test.com", nombre, null, true, null);
    ...
    {
        var command = new EnsureUsuarioCommand("auth0|123", "test@test.com", new string('a', 256), null, true, null);
